  ...
  return (
    <section id="principii" className="bg-cream-warm px-6 py-20 md:px-12 md:py-24">
      <div className="mx-auto max-w-[960px]">
        <div className="mb-5 text-center text-[10px] font-semibold uppercase tracking-[0.25em] text-teal md:text-left">
          {number} · {label}
        </div>
        <h2 className="mx-auto mb-14 max-w-[560px] text-center font-serif text-[26px] font-medium leading-[1.15] tracking-[-0.02em] text-brown md:mx-0 md:text-left md:text-[34px]">
          {titlePrefix}
